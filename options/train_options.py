...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_R', type=float, default=0.0002, help='initial learning rate for adam')
        ...
        parser.add_argument('--L1_lambda', type=float, default=10.0, help='weight for L1 loss between fake B and real B')
